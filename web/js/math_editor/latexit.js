  ...
  //  if(document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"))
	...
	latex : function(txt) {
		...
		if(this.isFirefox) {
		  ...
		  htmlinline=" <object type=\"image/svg+xml\" data=\"http://latex.codecogs.com/"+this.mode+".latex?$2\" class=\"latex\" /> ";
		}
		else {
		  html=" <img src=\"http://latex.codecogs.com/"+this.mode+".latex?$2\" border=\"0\" class=\"latex\" /> ";
		  htmlinline=" <img src=\"http://latex.codecogs.com/"+this.mode+".latex?$2\" border=\"0\" class=\"latex\" /> ";
		}
                
                txt=txt.replace(/(^\$\$|[^\\]\$\$)(.*?[^\\])\$\$/gm, " <br/>"+htmlinline+"<br/> "); 
