$(function() {
				...
				var gridWidth = 960,
					...
					config = [
					{
						...
						"bgcolor"	: "black",
						"text"		: "",
						//"text"		: "WikiGrads is a new academic network taking a student-driven, social approach to collaborative learning. Our mission is to help students learn from each other and study more efficiently."
					},
					{
						"screenNumber" 		: 2,
						"name"		: "home_init",
						...
						"bgcolor"	: "black",
						"text"		: "",
						//"text"		: "<H1>CONNECT</H1><P>Meet and connect with your classmates.</P>"
					},
					{
						"screenNumber" 		: 4,
						"bgcolor"	: "black",
						...
						"tooltipWidth" : 500,
						"text"		: "",
						//"text"		: "<H1>CONNECT</H1><P>Add your courses.</P>",
						"position"	: "T"
					},
					{
						"screenNumber" 		: 3,
						...
						"posY"		: 100,
						"tooltipWidth" : 250,
						//"text"		: "<H1>CONNECT</H1>...or just those in your course.",
						"position"	: "L"
					},
					{
						"screenNumber" 		: 7,
						...
						"tooltipWidth" : 700,
						"text"		: "",
						//"text"		: "<H1>CONNECT</H1><P>View new members or other WikiMates</P>",
						"position"	: "T"
					},
{
						"screenNumber" 		: 8,
						...
						"tooltipWidth" : 700,
						"text"		: "",
						//"text"		: "<H1>CONNECT</H1><P>Profiles give you basic information of other users.</P>",
						"position"	: "T"
					},
					{
						"screenNumber" 		: 9,
						...
						"tooltipWidth" : 150,
						"text"		: "",
						//"text"		: "<H1>CONNECT</H1><P>Give a few basic details about yourself</P>",
						"position"	: "B"
					},
					{
						"screenNumber" 		: 5,
						...
						"tooltipWidth" : 500,
						"text"		: "",
						//"text"		: "<H1>COLLABORATE</H1><P>View and download documents uploaded by WikiMates and other students</P>",
						"position"	: "B"
					},
					{
						"screenNumber" 		: 6,
						...
						"tooltipWidth" : 500,
						"text"		: "",
						//"text"		: "<H1>COLLABORATE</H1><P>Upload your own documents</P>",
						"position"	: "T"
					}
				],
				previousStep = false,
				...
				function showControls(){
					...
					//$('#tourcontrols').animate({'bottom':'30px'},500);
				}
