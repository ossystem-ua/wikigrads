...
<div class="wg-post-block">
    <div class="wg-post-col-1 wg-student">
        <?php echo link_to(image_tag(getUserThumbnail($notification['object']['user_id'], $notification['object']['user_image'], 50, 0, 0, 1)),'@user?id='.$notification['object']['user_id'].'&name='.Utils::slugify($user_name), array('class' => 'user-logo'))?>
    </div>
    <div class="wg-post-col-2">
        ...
        <div class="wg-post-row-2" style="display: table; width: 100%;">
            <div class="wg-post-col-1" style="width: 50%; text-align:left;">
                ...
                <?php if($notification['user_class_year']): ?>
                    <p>Class of: <?php echo $notification['user_class_year'] ?></p>
                <?php endif; ?>
                <?php if($notification['user_major']): ?>
                    <p>Major: <?php echo $notification['user_major'] ?></p>
                <?php endif; ?>
