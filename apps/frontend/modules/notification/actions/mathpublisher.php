...
//$dirfonts = (__DIR__)."/../../../../../web/fonts/formulas";
$dirfonts = "/web/fonts/formulas";
...
//$dirimg = (__DIR__)."/../../../../../web/images/formulas";
$dirimg = "/web/images/uploads";
// or $dirimg=dirname(__FILE__)."/phpmathpublisher/img";


//******************************************************************
function getSymboles() {
 return $symboles = array(
'~'=>' ',
'alpha'=>'&#174;',
'beta'=>'&#175;',
'gamma'=>'&#176;',
...
function getFontesmath() {
return $fontesmath = array(
'~'=>'FreeSerif',
'alpha'=>'cmmi10',
'beta'=>'cmmi10',
'gamma'=>'cmmi10',
...
{
$symboles = getSymboles();
$fontesmath = getFontesmath();
$dirfonts = (__DIR__)."/../../../../../web/fonts/formulas";
...
*/
//global $dirimg;
$dirimg = (__DIR__)."/../../../../../web/images/uploads";
$ret=0;
...
if ($v==0)
	...
	ImagePNG($formula->image,$dirimg."/math_".$v."_".$nameimg);
        chmod($dirimg."/math_".$v."_".$nameimg, 0777);
	}
$valign=$v-1000;
