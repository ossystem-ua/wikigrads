...
$t->is($o->computeAssetFilepath('lightbox', 'js', '/js'), sprintf('%s/js/lightbox.js', $baseAssetsDir), 'computeAssetFilepath() retrieves js asset filepath');
...
$t->is($o->computeAssetFilepath('lightbox.css', 'css', '/css'), sprintf('%s/css/lightbox.css', $baseAssetsDir), 'computeAssetFilepath() retrieves css asset filepath');
