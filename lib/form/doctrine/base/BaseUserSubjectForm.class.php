...
/**
 * UserSubject form base class.
 *
 * @method UserSubject getObject() Returns the current form's model object
 *
 * @package    Wikigrads
 * @subpackage form
 ...
 */
abstract class BaseUserSubjectForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('user_subject[%s]');
