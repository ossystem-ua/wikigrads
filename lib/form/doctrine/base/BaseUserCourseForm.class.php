...
/**
 * UserCourse form base class.
 *
 * @method UserCourse getObject() Returns the current form's model object
 *
 * @package    Wikigrads
 * @subpackage form
 ...
 */
abstract class BaseUserCourseForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('user_course[%s]');
