...
abstract class BaseUserNotificationForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'is_seen'         => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'notification_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Notification'), 'required' => false)),
      'is_seen'         => new sfValidatorBoolean(array('required' => false)),
