...
/**
 * FriendRequest form base class.
 *
 * @method FriendRequest getObject() Returns the current form's model object
 *
 * @package    Wikigrads
 * @subpackage form
 ...
 */
abstract class BaseFriendRequestForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'status'     => new sfValidatorChoice(array('choices' => array(0 => 'Pending', 1 => 'Accepted', 2 => 'Declined'), 'required' => false)),
