...
/**
 * UserSubject filter form base class.
 *
 * @package    Wikigrads
 * @subpackage filter
 ...
 */
abstract class BaseUserSubjectFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('user_subject_filters[%s]');
