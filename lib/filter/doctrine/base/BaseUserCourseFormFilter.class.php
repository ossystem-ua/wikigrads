...
/**
 * UserCourse filter form base class.
 *
 * @package    Wikigrads
 * @subpackage filter
 ...
 */
abstract class BaseUserCourseFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('user_course_filters[%s]');
