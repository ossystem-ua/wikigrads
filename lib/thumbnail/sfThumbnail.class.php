...
/**
 * sfThumbnail provides a mechanism for creating thumbnail images. (extended to create square thumbnails by MINH)
 *
...
class sfThumbnail
{
  ...
  */
   ...
   * Used by adapter
   */
  public function initThumb($sourceWidth, $sourceHeight, $maxWidth, $maxHeight, $scale, $inflate, $square = false)
  {
    if ($maxWidth > 0)
    {
    ...
    if($square)
    {
	    $this->thumbWidth = max($this->thumbWidth, $this->thumbHeight);
